...
{
    public $rules = array(); ////!< DataRequestConfig instance
    protected $request; //!< array of sorting rules
...
class Connector
{
    ...
    public static $filter_var = "dhx_filter"; //!< default value, used to generate auto-IDs
    public static $sort_var = "dhx_sort"; //!< db connection resource
    public static $kids_var = "dhx_kids";//DataConfig instance
    public $model = false;//DataRequestConfig instance
    public $access;//!< hash of names for used classes
    public $sql;//!< assigned encoding (UTF-8 by default)
    public $event;//!< flag of edit mode ( response for dataprocessor )
    public $limit = false;//!< flag of update mode ( response for data-update )
    protected $config;//!< flag of dyn. loading mode
    protected $request;
    protected $names; // actions table name for autoupdating
    protected $encoding = "utf-8";
    protected $editing = false;//!< extra info which need to be sent to client side
    protected $updating = false;//!< hash of OptionsConnector
    protected $dload; // render() returns string, don't send result in response
    protected $data_separator = "\n"; // render only data without any other info
    ...
    protected $filters;
    protected $sorts;
    protected $mix;  //!< AccessMaster instance
    protected $order = false;    //DataWrapper instance
    protected $attributes;    //EventMaster instance
    private $id_seed = 0;
